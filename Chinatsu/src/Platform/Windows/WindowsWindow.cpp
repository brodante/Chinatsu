...
#include "Chinatsu/Events/MouseEvent.h"
#include "Chinatsu/Events/KeyEvent.h"
...
namespace Chinatsu
{
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		// Set GLFW callbacks
		glfwSetWindowSizeCallback(m_Window, [](GLFWwindow* window, int width, int height) // Lambda function to capture the window data
			{
